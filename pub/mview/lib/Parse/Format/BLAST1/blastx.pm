# -*- perl -*-
# Copyright (c) 1996-1999  Nigel P. Brown. $Id: blastx.pm,v 1.2 1999/02/19 16:55:52 nbrown Exp $

###########################################################################
package Parse::Format::BLAST1::blastx;
...
###########################################################################
package Parse::Format::BLAST1::blastx::HEADER;
...
###########################################################################
package Parse::Format::BLAST1::blastx::RANK;
...
sub new {
	...
	if ($line =~ /\s*
	    ...
	    push @{$self->{'hit'}}, 
	    {
	     ...
	     'query_frame' => $2 . $3,  #merge sign and number components
	     'score'       => $4,
	     'p'           => $5,
	     'n'           => $6,
...
###########################################################################
package Parse::Format::BLAST1::blastx::HIT;
...
###########################################################################
package Parse::Format::BLAST1::blastx::HIT::SUM;
...
###########################################################################
package Parse::Format::BLAST1::blastx::HIT::ALN;
...
###########################################################################
package Parse::Format::BLAST1::blastx::WARNING;
...
###########################################################################
package Parse::Format::BLAST1::blastx::HISTOGRAM;
...
###########################################################################
package Parse::Format::BLAST1::blastx::PARAMETERS;

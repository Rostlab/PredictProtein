# -*- perl -*-
# Copyright (c) 1996-1999  Nigel P. Brown. $Id: blastn.pm,v 1.2 1999/02/19 16:55:50 nbrown Exp $

###########################################################################
package Parse::Format::BLAST1::blastn;
...
###########################################################################
package Parse::Format::BLAST1::blastn::HEADER;
...
###########################################################################
package Parse::Format::BLAST1::blastn::RANK;
...
###########################################################################
package Parse::Format::BLAST1::blastn::HIT;
...
###########################################################################
package Parse::Format::BLAST1::blastn::HIT::SUM;
...
###########################################################################
package Parse::Format::BLAST1::blastn::HIT::ALN;
...
###########################################################################
package Parse::Format::BLAST1::blastn::WARNING;
...
###########################################################################
package Parse::Format::BLAST1::blastn::HISTOGRAM;
...
###########################################################################
package Parse::Format::BLAST1::blastn::PARAMETERS;

# Copyright (c) 1997-1999  Nigel P. Brown. \$Id: HSSP.pm,v 1.22 1999/04/28 18:21:26 nbrown Exp $
...
sub parse {
	...
	if ($match->{'id'} =~ /\|/) {
	    ...
	    #looks like a swissprot derived HSSP file
	    $id = "swiss|$match->{'accnum'}|$match->{'id'}";
	} else {
	    #give up
	    $id = $match->{'id'};
	}

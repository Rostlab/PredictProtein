...
sequenceContainer1G molphyFormat::read(istream &infile, const alphabet* alph) {
...
//---------------------------------------------------------------------
//	vector<sequenceContainer1G::sequenceDatum*> vec;
...
void molphyFormat::write(ostream &out, const sequenceContainer1G& sd) {
	out<<sd.numberOfSequences()<<" "<<sd.seqLen()<<endl;

...
public:
	...
	explicit fromInstructionFile(int argc, char* argv[]);
	...
	void getStartingSequenceData(vector<sequenceContainer1G>& sdPtrVec,
		const vector<alphabet* >& _alphabets);
	void getOneStartingSequenceData(sequenceContainer1G& sdPtrVec,

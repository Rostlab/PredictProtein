...
chartvalue[10][1]=1.014; chartvalue[10][2]=1.476; chartvalue[10][3]=1.771;
chartvalue[10][4]=0.114; chartvalue[10][5]=1.667; chartvalue[10][6]=2.006;
chartvalue[10][7]=1.844;
chartvalue[11][1]=0.590; chartvalue[11][2]=0.646; chartvalue[11][3]=0.584;
chartvalue[11][4]=0.842; chartvalue[11][5]=0.307; chartvalue[11][6]=0.611;
chartvalue[11][7]=0.396;
chartvalue[12][1]=0.281; chartvalue[12][2]=3.351; chartvalue[12][3]=2.998;
chartvalue[12][4]=0.789; chartvalue[12][5]=4.868; chartvalue[12][6]=2.735;
chartvalue[12][7]=3.812;
chartvalue[13][1]=0.068; chartvalue[13][2]=2.103; chartvalue[13][3]=1.646;
chartvalue[13][4]=0.182; chartvalue[13][5]=0.664; chartvalue[13][6]=1.581;
chartvalue[13][7]=1.401;
chartvalue[14][1]=0.311; chartvalue[14][2]=2.290; chartvalue[14][3]=2.330;
chartvalue[14][4]=0.811; chartvalue[14][5]=2.596; chartvalue[14][6]=2.155;
chartvalue[14][7]=2.585;
chartvalue[15][1]=1.231; chartvalue[15][2]=1.683; chartvalue[15][3]=2.157;
chartvalue[15][4]=0.197; chartvalue[15][5]=1.653; chartvalue[15][6]=2.430;
chartvalue[15][7]=2.065;
chartvalue[16][1]=0.332; chartvalue[16][2]=0.753; chartvalue[16][3]=0.930;
chartvalue[16][4]=0.424; chartvalue[16][5]=0.734; chartvalue[16][6]=0.801;
chartvalue[16][7]=0.518;
chartvalue[17][1]=0.197; chartvalue[17][2]=0.543; chartvalue[17][3]=0.647;
chartvalue[17][4]=0.680; chartvalue[17][5]=0.905; chartvalue[17][6]=0.643;
chartvalue[17][7]=0.808;
chartvalue[18][1]=0.918; chartvalue[18][2]=0.002; chartvalue[18][3]=0.385;
chartvalue[18][4]=0.440; chartvalue[18][5]=0.138; chartvalue[18][6]=0.432;
chartvalue[18][7]=0.079;
chartvalue[19][1]=0.066; chartvalue[19][2]=0.064; chartvalue[19][3]=0.065;
chartvalue[19][4]=0.747; chartvalue[19][5]=0.006; chartvalue[19][6]=0.115;
chartvalue[19][7]=0.014;
chartvalue[20][1]=0.004; chartvalue[20][2]=0.108; chartvalue[20][3]=0.018;
chartvalue[20][4]=0.006; chartvalue[20][5]=0.010; chartvalue[20][6]=0.004;
chartvalue[20][7]=0.007;
}
void  Init_oldchart()
{
  chartvalue[1][1]=3.167; chartvalue[1][2]=0.297; chartvalue[1][3]=0.398;
  chartvalue[1][4]=3.902; chartvalue[1][5]=0.585; chartvalue[1][6]=0.501;
  chartvalue[1][7]=0.483;
  chartvalue[2][1]=2.597; chartvalue[2][2]=0.098; chartvalue[2][3]=0.345;
  chartvalue[2][4]=0.894; chartvalue[2][5]=0.514; chartvalue[2][6]=0.471;
  chartvalue[2][7]=0.431;
  chartvalue[3][1]=1.665; chartvalue[3][2]=0.403; chartvalue[3][3]=0.386;
  chartvalue[3][4]=0.949; chartvalue[3][5]=0.211; chartvalue[3][6]=0.342;
  chartvalue[3][7]=0.360;
  chartvalue[4][1]=2.240; chartvalue[4][2]=0.37;  chartvalue[4][3]=0.480;
  chartvalue[4][4]=1.409; chartvalue[4][5]=0.541; chartvalue[4][6]=0.772;
  chartvalue[4][7]=0.663;
  chartvalue[5][1]=0.531; chartvalue[5][2]=0.076; chartvalue[5][3]=0.403;
  chartvalue[5][4]=0.662; chartvalue[5][5]=0.189; chartvalue[5][6]=0.106;
  chartvalue[5][7]=0.013;
  chartvalue[6][1]=1.417; chartvalue[6][2]=0.090; chartvalue[6][3]=0.122;
  chartvalue[6][4]=1.659; chartvalue[6][5]=0.19;  chartvalue[6][6]=0.13;
  chartvalue[6][7]=0.1550;
  chartvalue[7][1]=0.045; chartvalue[7][2]=0.275; chartvalue[7][3]=0.578;
  chartvalue[7][4]=0.216; chartvalue[7][5]=0.211; chartvalue[7][6]=0.426;
  chartvalue[7][7]=0.156;
  chartvalue[8][1]=1.297; chartvalue[8][2]=1.551; chartvalue[8][3]=1.084;
  chartvalue[8][4]=2.612; chartvalue[8][5]=0.377; chartvalue[8][6]=1.248;
  chartvalue[8][7]=0.877;
  chartvalue[9][1]=1.375; chartvalue[9][2]=2.639; chartvalue[9][3]=1.763;
  chartvalue[9][4]=0.191; chartvalue[9][5]=1.815; chartvalue[9][6]=1.961;
  chartvalue[9][7]=2.795;
  chartvalue[10][1]=0.659; chartvalue[10][2]=1.163; chartvalue[10][3]=1.210;
  chartvalue[10][4]=0.031; chartvalue[10][5]=1.358; chartvalue[10][6]=1.937;
  chartvalue[10][7]=1.798;
  chartvalue[11][1]=0.347; chartvalue[11][2]=0.275; chartvalue[11][3]=0.679;
  chartvalue[11][4]=0.395; chartvalue[11][5]=0.294; chartvalue[11][6]=0.579;
  chartvalue[11][7]=0.213;
  chartvalue[12][1]=0.262; chartvalue[12][2]=3.496; chartvalue[12][3]=3.108;
  chartvalue[12][4]=0.998; chartvalue[12][5]=5.685; chartvalue[12][6]=2.494;
  chartvalue[12][7]=3.048;
  chartvalue[13][1]=0.03;  chartvalue[13][2]=2.352; chartvalue[13][3]=2.268;
  chartvalue[13][4]=0.237; chartvalue[13][5]=0.663; chartvalue[13][6]=1.62;
  chartvalue[13][7]=1.448;
  chartvalue[14][1]=0.179; chartvalue[14][2]=2.114; chartvalue[14][3]=1.778;
  chartvalue[14][4]=0.631; chartvalue[14][5]=2.55;  chartvalue[14][6]=1.578;
  chartvalue[14][7]=2.526;
  chartvalue[15][1]=0.835; chartvalue[15][2]=1.475; chartvalue[15][3]=1.534;
  chartvalue[15][4]=0.039; chartvalue[15][5]=1.722; chartvalue[15][6]=2.456;
  chartvalue[15][7]=2.280;
  chartvalue[16][1]=0.382; chartvalue[16][2]=0.583; chartvalue[16][3]=1.052;
  chartvalue[16][4]=0.419; chartvalue[16][5]=0.525; chartvalue[16][6]=0.916;
  chartvalue[16][7]=0.628;
  chartvalue[17][1]=0.169; chartvalue[17][2]=0.702; chartvalue[17][3]=0.955;
  chartvalue[17][4]=0.654; chartvalue[17][5]=0.791; chartvalue[17][6]=0.843;
  chartvalue[17][7]=0.647;
  chartvalue[18][1]=0.824; chartvalue[18][2]=0.022; chartvalue[18][3]=0.308;
  chartvalue[18][4]=0.152; chartvalue[18][5]=0.180; chartvalue[18][6]=0.156;
  chartvalue[18][7]=0.044;
  chartvalue[19][1]=0.24;  chartvalue[19][2]=0;     chartvalue[19][3]=0.00;
  chartvalue[19][4]=0.456; chartvalue[19][5]=0.019; chartvalue[19][6]=0.00;
...
void  Get_info()
{
  ...
  weightchar='\0';
  while ((weightchar!='n') && (weightchar!='y') && (weightchar!='Y') && (weightchar!='N')  && (weightchar!=(char) 13))
     scanf("%c",&weightchar);
...
void  Select_option()
{
    ...
    printf("ENTER OPTION: ");
  while ((option!='a') && (option!='b') && (option!='c') && (option!='A') && (option!='B') && (option!='C') && (option!='p') && (option!='P')) {
     scanf("%c",&option);
  } /* endwhile */
    printf("\n");
...
void  Store_residues()
  /* stores only the amino acids of the sequence, skipping numbers, blanks,
     and carriage returns and ending with '/' || '*' */
{
  ...
  if (tempstore == '/') fgets(junkline,9999,protein); /* read other '/' at end */
}
  ...
  /* calculates best scores for each window frame */
{
  ...
  while (index<=endindex)
  {
   ...
   do {
    ...
    for (heptad_pos=0; heptad_pos<=6; heptad_pos++)  /* go through each residue in each heptad pos */
    {
      scores=1.0;
      hept=1;
      for (window_pos=0;window_pos<=window-1;window_pos++)  /* get values at all 21 positions */
      {
   ...
   for (extras=1; extras<=window-1;extras++)
   {
    ...
    temphept[index][res_pos+extras]=(int) fmod((double) (temphept[index][res_pos]+extras),7.0);
   }
   window=window+7;
   index=index+1;
    ...
    do {
      ...
      if (res_pos-window_pos<1) window_pos=window-1;
       ...
       if (tempcalc[index][res_pos-window_pos]>calcnumb[index][res_pos])
       {
         ...
         heptnum[index][res_pos]=(int) fmod((temphept[index][res_pos-window_pos]+window_pos),7.0);
       } /* endif */
...
double Calcprob(double x,double meancc,double stddevcc,double meangl,double stddevgl,double ratio_gl_cc)
{

...
void   svm_learn_classification(DOC *, double *, long, long, LEARN_PARM *, KERNEL_PARM *, KERNEL_CACHE *, MODEL *);
void   svm_learn_regression(DOC *, double *, long, long, LEARN_PARM *, KERNEL_PARM *, KERNEL_CACHE *, MODEL *);
void   svm_learn_ranking(DOC *, double *, long, long, LEARN_PARM *, KERNEL_PARM *, KERNEL_CACHE *, MODEL *);
...
double compute_objective_function(double *, double *, double *, double, long *, long *);
...
void   get_kernel_row(KERNEL_CACHE *,DOC *, long, long, long *, CFLOAT *, KERNEL_PARM *);
void   cache_kernel_row(KERNEL_CACHE *,DOC *, long, KERNEL_PARM *);
void   cache_multiple_kernel_rows(KERNEL_CACHE *,DOC *, long *, long, KERNEL_PARM *);
...
double xa_estimate_error(MODEL *, long *, long *, long, DOC *,
			 double *, double *, KERNEL_PARM *, LEARN_PARM *);

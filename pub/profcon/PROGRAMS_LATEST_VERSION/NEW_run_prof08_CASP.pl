...
system ("${root_dir}/PROGS/blastpgp.pl $input_fasta saf maxAli=3000 eSaf=1 exe=${root_dir}/PROGS/blastpgp");

if (system ("grep \"*** No hits found ***\" ${root_dir}/${tmp_nm}.blastpgp") != 0) {

system ("${root_dir}/PROGS/copf.pl ${root_dir}/${tmp_nm}.saf hssp");
system ("${root_dir}/PROGS/hssp_filter.pl ${root_dir}/${tmp_nm}.hssp red=80");
system ("${root_dir}/PROGS/prof ${root_dir}/${tmp_nm}-fil.hssp");

	}

else {
       system ("${root_dir}/PROGS//prof $input_fasta");
       system ("mv ${root_dir}/${tmp_nm}.rdbProf ${root_dir}/${tmp_nm}-fil.rdbProf");
    }

$input_hssp=${root_dir}."/".${tmp_nm}."-fil.hssp";
$input_prof=${root_dir}."/".${tmp_nm}."-fil.rdbProf";
...
system("${root_dir}/PROGS/order_CASP.pl $user_name $input_hssp");
...
system("${root_dir}/PROGS/format_CASP.pl $user_name $input_fasta");

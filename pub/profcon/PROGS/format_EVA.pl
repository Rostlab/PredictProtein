...
print FRMT_F "TARGET","\t",$user_name_true,"\n";
#print FRMT_F "AUTHOR","\t","Marco Punta & Burkhard Rost, CUBIC, Columbia University New York","\n";
print FRMT_F "AUTHOR","\t","rost_PROFcon-SERVER","\n";
print FRMT_F "REMARK","\t","Reference: M Punta and B Rost - PROFcon: novel prediction of long-range contacts ","\n";
print FRMT_F "REMARK","\t","Reference: Bioinformatics 2005 , in press","\n";
print FRMT_F "METHOD","\t","Feed Forward Neural Network with Back Propagation","\n";
print FRMT_F "MODEL","\t","1","\n";

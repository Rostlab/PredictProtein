...
c	WRITE(6,*)'chainremark: ',chainremark
     ...
     +        ' chain(s) used here ; chain(s) : ',chainremark(1:istop)
      ENDIF
      WRITE(KHSSP,'(A,I6)')  'NALIGN     ',NALIGN
...
C internal
      ...
      WRITE(6,*) 'INFO: sub SCALE_SSSA_PROFILE_METRIC executed here'
...
C
     ...
     +     MAPLOW.EQ.0.0 .AND. MAPHIGH.EQ.0.0) THEN
      ...
      WRITE(6,*)' SCALEINTERVAL: scale between SMIN/SMAX',
     +        SMIN,SMAX
         DO I=1,N
         ...
         ENDDO
      ELSE
         WRITE(6,*)' SCALEINTERVAL: scale between MAPLOW/MAPHIGH',
     +        MAPLOW,MAPHIGH
         SHI=MAPHIGH
         SLO=MAPLOW
      ENDIF
      WRITE(6,*)'high/low smin/smax before: ',shi,slo,smin,smax
      DO I=1,N
...
c        WRITE(6,'(20F5.2)')(S(I),I=1,N)
      ...
      DO I=1,N
         ...
         IF (S(I) .LT. SLO)SLO=S(I)
      ENDDO
      WRITE(6,*)'high/low smin/smax after: ',shi,slo,smin,smax
...
C     +                          CONSWEIGHT_1(I)
	    ...
	    ENDDO
         ...
         ENDIF
      ENDIF
      IF (PROFILEMODE .GE. 2 .AND. PROFILEMODE .LT. 7 ) THEN
         IF (LCONSERV_2) THEN
	    DO K=1,NTRANS 
               DO I=N2BEG,N2END 
                  METRIC_2(I,K)  = SIMMETRIC_2(I,K) * CONSWEIGHT_2(I)

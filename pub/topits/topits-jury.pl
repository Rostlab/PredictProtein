...
#-------------------------------------------------------------------------------
    ...
    $par{"dirTopits"}=          "/home/$ENV{USER}/server/pub/topits/";        # topits central
    $par{"dirTopitsBin"}=       "/home/$ENV{USER}/server/pub/topits/bin/";    # binaries (metric asf)
    $par{"dirTopitsMat"}=       "/home/$ENV{USER}/server/pub/topits/mat/";    # material (metric asf)
    $par{"dirTopitsScripts"}=   "/home/$ENV{USER}/server/pub/topits/scr/"; # scripts (maxhom.csh)
    $par{"dirMaxhom"}=          "/home/$ENV{USER}/server/pub/max/";           # maxhom central
    $par{"dirMaxhomBin"}=       "/home/$ENV{USER}/server/pub/max/bin/";       # maxhom central
    $par{"dirMaxhomMat"}=       "/home/$ENV{USER}/server/pub/max/mat/";       # maxhom central
				# --------------------
				# input files

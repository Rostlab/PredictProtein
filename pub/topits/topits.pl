...
#----------------------------------------------------------------------
	...
	if (! -e $par{"fileDefaults"}){ 
	    $par{"fileDefaults"}="/home/$ENV{USER}/server/pub/topits/Defaults.topits"; }
...
#	                        $par{"dirTopitsMat"}. "Maxhom_McLachlan.metric"; # metric
    ...
    $par{"fileMetricIn"}=       
#	                        $par{"dirTopitsMat"}. "Topits_m3c_in.metric";    # 3state metric
...
#-------------------------------------------------------------------------------
	...
	require "/home/$ENV{USER}/server/pub/topits/scr/lib-topits.pl"; }
...
#-------------------------------------------------------------------------------
    $par{"fileDefaults"}=       "/home/$ENV{USER}/server/pub/topits/mat/Defaults.topits"
	if (! -e $par{"fileDefaults"});
    $par{"fileMaxhomDefaults"}= "/home/$ENV{USER}/server/pub/topits/mat/Defaults.maxhom"
	if (! -e $par{"fileMaxhomDefaults"});

    $par{"dirTopits"}=          "/home/$ENV{USER}/server/pub/topits/";
    $par{"dirBin"}=             "/home/$ENV{USER}/server/bin/";

    $par{"dirTopitsScr"}=       "/home/$ENV{USER}/server/pub/topits/scr/";
    $par{"dirTopitsMat"}=       "/home/$ENV{USER}/server/pub/topits/mat/";

    $par{"dirPhd"}=             "/home/$ENV{USER}/server/pub/phd/";

...
#-------------------------------------------------------------------------------
	...
	require "/home/$ENV{USER}/ut/perl/lib-ut.pl";
	require "/home/$ENV{USER}/ut/perl/lib-prot.pl";
	require "/home/$ENV{USER}/ut/perl/lib-comp.pl";
	require "/home/$ENV{USER}/ut/perl/ctime.pl"; }
...
#-------------------------------------------------------------------------------
    $par{"fileDefaults"}=       "/home/$ENV{USER}/ut/topits/Defaults.topits"
	if (! -e $par{"fileDefaults"});
    $par{"fileMaxhomDefaults"}= "/home/rost/ut/max/maxhom.defaults"
	if (! -e $par{"fileMaxhomDefaults"});

    $par{"dirTopits"}=          "/home/$ENV{USER}/ut/topits/";
    $par{"dirBin"}=             "/home/$ENV{USER}/bin/$ARCH/";
    $par{"dirBin"}=             "/home/$ENV{USER}/bin/$ARCH/";

    $par{"dirTopitsScr"}=       "/home/$ENV{USER}/ut/topits/scr/";
    $par{"dirTopitsMat"}=       "/home/$ENV{USER}/ut/topits/mat/";

    $par{"dirExeScripts"}=      "/home/$ENV{USER}/ut/perl/";
    $par{"dirExePhd"}=          "/home/$ENV{USER}/ut/phd/";

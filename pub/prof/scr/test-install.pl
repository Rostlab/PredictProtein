...
%par=(
      '', "",			# 
      'exeProf',                "/nfs/data5/users/ppuser/server/pub/prof/prof",   # PROF (perl script)
      'fhTrace',                "FHTRACE",                    # file handle for trace file
      'fileScreen',             "XTST-PROF-SCREEN".".tmp",    # trace file
      'dirExa',                 "/nfs/data5/users/ppuser/server/pub/prof/exa/",   # directory pointing to PROF examples
      );

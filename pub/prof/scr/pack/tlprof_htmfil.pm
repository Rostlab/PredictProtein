...
package tlprof_htmfil;

#===============================================================================
sub htmfil {
#-------------------------------------------------------------------------------
#   htmfil                   package version of script
#-------------------------------------------------------------------------------
    ...
    $script_name      = "tlprof_htmfil";
    $script_goal      = "filter the transmembrane regions for PROF/PHD file";
    $script_input     = ".rdb file from PHD/PROF";
...
#------------------------------
    die("ERROR:\t file $file_in does not exist") if (! -e $file_in);

    print "--- htmfil after ini phase\n";
...
#----------------------------------------
	...
	print "*** ERROR in htmfil reading of dotpred_phd not supported anymore\n" x 10; 
	die(1);
...
#--------------------------------------------------------------------------------
	...
	else {print"*** htmfil_prof, conv_vec2ass: unknown des=$des,\n";}
    }
}				# end of conv_vec2ass

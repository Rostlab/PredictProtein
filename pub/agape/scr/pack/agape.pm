...
#    foreach $key (sort keys %main::par){ print "par key: $key\n"; }
    ...
    $BlastForProfCmd="$main::par{blastpgp_exe} -i $FastaInLoc -d $main::par{traindb} -j 2 -o $BlastForProfOut -e 1 -h 0.01 -v 1000 -b 1000 -a 2 -F F";
    print "executing:\n$BlastForProfCmd\n"  if($dbg);
    ...
    $BlastForProfileCmd="$main::par{blastpgp_exe} -i $FastaInLoc -d $main::par{traindb} -j 7 -o $BlastForProfileTmp -Q $BlastMatOut -e 0.001 -h 0.001 -v 3000 -b 3000 -a 2 -F F -m 9";
    print "executing:\n$BlastForProfileCmd\n"  if($dbg);

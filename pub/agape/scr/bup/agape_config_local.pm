...
$par{'agape_pack'}            =$par{'scripts'}."pack/"."agape_local.pm";
...
$par{'parseStripFrwd_exe'}    =$par{'scripts'}."parseStripFrwd_loc.pl";
$par{'parseStripRvsd_exe'}    =$par{'scripts'}."parseStripRvsd_loc.pl";
...
$par{'K_evd'}                 =0.035;
$par{'lambda_evd'}            =0.255;
$par{'db_residue_ct'}        =500000;

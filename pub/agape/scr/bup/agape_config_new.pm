...
$par{'agape_pack'}            =$par{'scripts'}."pack/"."agape_new.pm";
...
$par{'mpearson2ALmpdb_exe'}   =$par{'scripts'}."mpearson2pdb.pl_new";
...
$par{'db_dssp_list'}          =$par{'mat'}."db_dssp_short.list";
$par{'db_sssa_list'}          =$par{'mat'}."db_sssa_short.list";

...
#-------------------------------------------------------------------------------
	...
	$par{"dirHome"}=            "/home/rost/pub/prof/";
    }
    elsif ($0=~/phd/){
	$par{"dirHome"}=            "/home/rost/pub/phd/";
    }
    else {
	$par{"dirHome"}=            "/usr/pub/molbio/prof/";
    }
...
#-------------------------------------------------------------------------------
	...
	$0=~/prof/){
	$par{"dirSrcMat"}=      "/home/rost/pub/prof/". "mat/";   # general material
	$par{"dirPerl"}=        "/home/rost/pub/prof/". "scr/";   # perl libraries
	$par{"dirPerlScr"}=     "/home/rost/pub/prof/". "scr/";   # perl scripts needed

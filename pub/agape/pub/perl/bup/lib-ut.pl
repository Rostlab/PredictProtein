...
#===============================================================================
#
#    PERL library for general utility subroutines
#
#===============================================================================
# 
#   
#                               ---------------------
#   lib-ut                      internal subroutines:
#                               ---------------------
# 
#   complete_dir                
#   completeDir                 
...
# -----------------------------------------------------------------------------# 
#                               ---------------------
#   lib-ut                      external subroutines:
#                               ---------------------
# 
#   call from lib-br:           errSbr,month2num
# 
#   call from system:           echo '$messageLoc' | $exe_mailLoc -s PP_ERROR $userLoc
#     chmod u+rwx $argIn
#     chmod go+rx $argIn
#     $cmd
#     echo '$messageLoc' | $exe_mailLoc -s PP_ERROR $userLoc
# 
#   call from missing:          ctime,localtime
# 
# 
##
#===============================================================================
...
#-------------------------------------------------------------------------------
    ...
    $excLoc=$modeLoc=0                             if (! defined $exclLoc || ! defined $modeLoc);
				# ------------------------------
				# system call
				# ------------------------------
...
#       out:                    USER
#-------------------------------------------------------------------------------
    $sbrName="lib-ut:"."sysGetUser";$fhinLoc="FHIN"."$sbrName";
    if (defined $ENV{'USER'}){
        return($ENV{'USER'});}
    $tmp=`whoami`;
...
#       out:                    0|1
#-------------------------------------------------------------------------------
    $sbrName="lib-ut:"."sysRmdir";$fhinLoc="FHIN"."$sbrName";

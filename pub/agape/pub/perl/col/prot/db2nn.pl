...
#
    ...
    $fileTrue=   $ARGV[1];	# file with true alignments
    $filePred=   $ARGV[2];	# file with predicted alignments
...
#--------------------------------------------------------------------------------
    ...
    $par{"fileOut"}=            "unk";
				# file extensions
    $par{"preDbg"}=             "DebugShift_";
    $par{"extDbg"}=             ".tmp";
    $par{"preOut"}=             "DbX_";
    $par{"extOut"}=             ".rdb";
				# file handles
    $fhout=                     "FHOUT";
    $fhoutDbg=                  "FHOUT_DbgShift";
    $fhin=                      "FHIN";
				# --------------------
				# further
				# computing Alignment Shift
    $par{"shiftPenalty"}=       0;   # penalty for insertions in Pred

...
#-------------------------------------------------------------------------------
    ...
    $cmd.= " ".$fileMetricInSeqLoc if ($fileMetricInSeqLoc !~ /McLachlan/i);
	...
	&sysCpfile($fileMetricOutLocTmp,$fileMetricOutLoc);
				...
				# ******************************
				# change name
    $par{"fileMetricLoc"}=$fileMetricOutLocTmp;
				# 
...
# 		       $dirPdbLoc,$fileOutHssp,$fileOutStrip,$fileOutHsspX);
	...
	$fileTmp="";}
    $fileTmp.="TOPITS_MAXHOMcmd_".$jobidLoc.".tmp";

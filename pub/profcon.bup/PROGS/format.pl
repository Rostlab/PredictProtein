...
if (@ARGV<2){ die "Usage: $0 input_sequence \n";}
...
$frmt=$root_dir."/".$in_name.".profcon";
#print $frmt."\n";
#$frmt="/home/$ENV{'USER'}/server/work/".$in_name.".profcon";
open(FRMT_F,">$frmt");
...
@<<<<<< @<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
"REMARK","Reference: Toward Good 2D Predictions in Proteins, submitted"
@<<<<<< @<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

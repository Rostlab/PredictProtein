...
foreach $dir ($dirScr,
	      ...
	      "/nfs/home1/yachdav/work/SNAP/prof/scr/",
	      "/nfs/home1/yachdav/work/SNAP/prof/scr/lib/",
	      "/nfs/home1/yachdav/work/SNAP/prof/scr/pack/"
	      ){
    foreach $lib (@lib) {
...
#    "[swissprot-id:paho_didma]"
    ...
    $par{"txt","contactWeb"}=      "http://rostlab.org";
    $par{"url","pp"}=              "http://predictprotein.org";
#    $par{"txt"}=       "";
...
#	next if ($arg eq $ARGV[1]);
    ...
    $modeWrt.="html:head," if $par{html_head};
    $modeWrt.="html:body," if $par{html_body};

...
#	print $fhoutHtml "<P><BR><R></HR>\n";
    ...
    if ($Ldetail) {
	print $fhoutHtml "</PRE>\n";
	print $fhoutHtml "<h3><A NAME=\"prof_detail\">Prediction (detailed)</A></h3><P>\n";
	print $fhoutHtml "<PRE>\n";
	$#kwdBodyTmp=0;
	foreach $kwd (@kwdBody) {
	    next if ($kwd=~/^RI/ || 
...
#	"<UL>\n";
#    print $fhoutHtml 
#	"<LI><A HREF=\"#prof_syn\">SYNOPSIS of prediction</A></LI>\n",
#	"\t <OL>\n";
#    print $fhoutHtml 
...
#	"\t </OL>\n",
#	"<LI><A HREF=\"#prof_body_pred\">BODY with predictions </A><BR>\n",
...
#	"<P><BR>\n";
				...
				# summary for protein
				# --------------------------------------------------
#    print $fhoutHtml '<A NAME=\"prof_syn\"></A>',
#    "<HR><H3><A NAME=\"prof_syn\">Prediction Summary</A></H3>\n";
#	"<BR><HR><BR>\n",
#	"<!-- -------------------------------------------------------------------------------- -->\n",
#	"<!-- BEG SUMMARY -->\n",
#	"<TABLE CELLPADDING=1 CELLSPACING=2 BORDER=1 WIDTH=100%>\n",
...
#	"</TABLE>\n";
	...
	print $fhoutHtml 
	    "<h3><A NAME=\"prof_syn_class\">PROFsec summary</A></h3>\n";
	$rdb{"sec","class","txt"}=~s/\n/\n<LI>/g;
...
#	print $fhoutHtml "<P><BR><P>\n";
	...
	print $fhoutHtml 
#	    "<UL>\n",
	    "<h3><A NAME=\"prof_syn_seccom\">Predicted secondary structure composition</A></h3>",
#	    "for your protein:</A></STRONG>\n",
	...
	print $fhoutHtml 
	    "<h3><A NAME=\"prof_syn_htm\">PROFhtm summary</A></h3>\n";
...
#     }
    ...
    if (defined $rdb{"1","PREL"}) {
	print $fhoutHtml 
	    "<h3><A NAME=\"prof_syn_acccom\">Predicted solvent accessibility composition ",
	    "(core/surface ratio) for your protein:</A></h3>\n",
	    "\t Classes used:\n",
	    "\t <UL>\n",
...
#	"</TABLE>\n";
    ...
    print $fhoutHtml 
#	"<UL>\n",
	"<h3><A NAME=\"prof_hdr_prot\">About your protein:</A></h3>\n",
	"<TABLE  CELLPADDING=2>\n";
    foreach $kwd (@kwdHead){
	next if ($kwd !~/^prot/);
	next if (! defined $rdb{$kwd});
...
#	"</UL><P>\n";
	...
	"<h3><A NAME=\"prof_hdr_res\">Residue composition for your protein:</A></h3>\n",
	"<TABLE  CELLPADDING=2>\n",
	"<TR>";
    $ct=0;
...
#	"</LI></UL>",
    ...
    print $fhoutHtml 
#	"<HR>\n",
	"<H3><A NAME=\"prof_body_pred\">Prediction (brief)</A></H3>\n";
#	"<BR><H3><A NAME=\"prof_body_pred\">BODY with predictions for ".$prot_id." ".$prot_nameTxt."</A></H3>\n";
#	"<P><BR><P>\n",
#	"<BR><P><BR>\n",
#	"<!-- -------------------------------------------------------------------------------- -->\n",
#	"<!-- BEG BODY -->\n",

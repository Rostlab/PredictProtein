...
#		   'profhtm',
	 ...
	 'blastpsi'=>{
	     ...
	     'taskabbr'=> 'ali',
	     'admin'   => 'BLASTP admin,blast-help@ncbi.nlm.nih.gov',
	     'doneby'  => 'S F Altschul, T L Madden, A A Sch�ffer, J Zhang, Z Zhang, W Miller, and D J Lipman',
	     'quote'   => 'S F Altschul, T L Madden, A A Sch�ffer, J Zhang, Z Zhang, W Miller, and D J Lipman:: Gapped BLAST and PSI-BLAST: a new generation of protein database search programs. Nucleic Acids Res, 25,3389-3402, 1997',
